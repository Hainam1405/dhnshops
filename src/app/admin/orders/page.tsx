  ...
  return (
    <div className="mx-auto max-w-5xl px-5 py-12 md:px-8">
      <header className="flex flex-wrap items-center justify-between gap-4 border-b border-line pb-6">
        <div>
          <p className="font-mono text-xs uppercase tracking-widest text-accent">Orders</p>
          <h1 className="display mt-2 text-3xl">Customer orders</h1>
        </div>
      ...
      <div className="mt-8 grid grid-cols-2 gap-4 md:grid-cols-4">
        ...
        <StatCard label="New / unfulfilled" value={String(stats.newCount)} />
      </div>
                    ...
                    <button
                      ...
                      className={
                        o.status === "fulfilled"
                          ...
                          : "rounded-full border border-line px-3 py-1 font-mono text-[10px] uppercase tracking-widest text-muted hover:border-accent hover:text-accent"
                      }
                    >
